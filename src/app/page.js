        ...
        <div className="hero-content">
          <div className="hero-header">
            ...
            <div className="hero-header-col-sm">
              <Copy animateOnScroll={false} delay={showPreloader ? 6.2 : 0.9}>
                <h3>
                  Designing and developing web applications for the next generation of startups.
                </h3>
              </Copy>
            </div>
          </div>
          ...
          <div className="hero-footer">
            <div className="hero-footer-col-lg">
              <Copy animateOnScroll={false} delay={showPreloader ? 6.2 : 0.9}>
                <p className="sm caps mono">Roshan Studios</p>
                <p className="sm caps mono">San Francisco</p>
              </Copy>
            </div>
            <div className="hero-footer-col-sm">
              <div className="hero-tags">
                <Copy animateOnScroll={false} delay={showPreloader ? 6.2 : 0.9}>
                  <p className="sm caps mono">Design Systems</p>
