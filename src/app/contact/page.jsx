    ...
    <div className="contact" ref={contactRef}>
      ...
      <div className="contact-copy">
        <div className="contact-copy-bio">
          <Copy delay={1}>
            <p className="caps sm">Roshan Studios</p>
            <p className="caps sm">San Francisco / Copenhagen</p>
          </Copy>
        </div>
        ...
        <div className="contact-copy-addresses">
          <div className="contact-address">
            <Copy delay={1.3}>
              <p className="caps sm">San Francisco</p>
              <p className="caps sm">E San Francisco St</p>
              <p className="caps sm">San Francisco, CA 94133</p>
            </Copy>
          </div>
        ...
        <div className="fc-col-lg">
          <div className="footer-text">
            <div className="footer-text-content">
              <p className="sm caps">Developed by 9M</p>
            </div>
          </div>
        </div>
